...
sudo apt install -y cmake tree vim curl net-tools xclip neofetch zsh zsh-syntax-highlighting zsh-autosuggestions libaio-dev ntfs-3g ntfs2btrfs openjdk-11-jdk python3 python3-pip clang erlang elixir golang nasm ruby perl clisp haskell-platform lua5.3 valabind valac valac-bin valadoc ninja-build meson arduino kubernetes php apktool git ssh zip unzip jq xmlstarlet htop qemu libvirt0 openvpn network-manager-openvpn-gnome openvpn-systemd-resolved fonts-powerline fonts-firacode fonts-noto-color-emoji docker-compose dconf-cli gnome-boxes gnome-tweak-tool gnome-sushi geary cheese gnome-audio gnome-builder gnome-calendar gnome-clocks gnome-contacts gnome-dictionary gnome-documents gnome-multi-writer gnome-photos gnome-remote-desktop gnome-shell-extension-gsconnect gnome-shell-extension-gsconnect-browsers gnome-sound-recorder gnome-todo gnome-weather peek pitivi gnome-music dconf-editor eog gnome-logs epiphany-browser gnome-books almanah seahorse gnome-system-monitor gnome-terminal tilix gnome-usage file-roller meld evince polari vinagre totem nautilus chrome-gnome-shell gnome-shell-extension-appindicator gnome-shell-extension-caffeine gnome-shell-extension-arc-menu gnome-shell-extension-dash-to-panel gnome-shell-extension-draw-on-your-screen gnome-shell-extension-hard-disk-led gnome-shell-extension-system-monitor
